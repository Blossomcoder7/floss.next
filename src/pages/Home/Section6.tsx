...
import bg from "@/assets/images/eco-bg.png";
import mint from "@/assets/images/straw-corner.png";

const Section6 = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2  auto-rows-fr w-full bg-[#FCE4DC] overflow-hidden min-h-fit relative">
      <div className="absolute -bottom-12 z-1 -right-12 w-40 h-40 flex items-center justify-center">
        <Image
          fill
          src={mint}
          alt="corner"
      ...
      <div className=" relative z-2 col-span-full md:col-span-1 md:-order-1 w-full h-full ">
      ...
      <div className=" relative z-2 py-10 col-span-full md:col-span-1    w-full h-full  text-[#231F20] p-5 pl-10 md:pl-14 space-y-4 ">
        <div className=" italic text-[clamp(80px,6vw,95px)]">Eco-Friendly</div>
